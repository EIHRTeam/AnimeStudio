...
namespace AnimeStudio
{
    public class Object
    {
        ...
        public Object(ObjectReader reader)
        {
            ...
            Logger.Verbose($"Attempting to read object {type} with {m_PathID} in file {assetsFile.fileName}, starting from offset 0x{reader.SourceByteStart:X8} with size of 0x{byteSize:X8} !!");
